...
- [Why you should learn React?](#why-you-should-learn-react)
- [How long does it take to learn React?](#how-long-does-it-take-to-learn-react)
- [Is React hard to learn?](#is-react-hard-to-learn)
- [What to learn before learning React?](#what-to-learn-before-learning-react)
- [React developer roadmap](#react-developer-roadmap)
- [How to start coding using React](#how-to-start-coding-using-react)
- [Best React Tutorials for Beginners](#best-react-tutorials-for-beginners)
- [Best Advanced React Tutorials](#best-advanced-react-tutorials)

- [Best Way to Learn React Free](#best-way-to-learn-react-free)
- [Online React Courses](#online-react-courses)


- [Awesome things regarding the React](#awsome-things-regarding-the-react)
...
React (also known as React.js or ReactJS) is a free and open-source JavaScript library. It is used to create user interfaces based on UI components. It is maintained by Meta (Facebook) and a community of individual developers and companies. The library first appeared in 2013 and is now one of the most commonly used frontend libraries for web development.
...
And it is not only used by top tech companies like Facebook, Netflix, Twitter but also by any companies that want to build incredible products fast.
...
The next reason why learning React is worth your time and money is because React is very popular among developers around the world.
...
If you have no programming experience. The first thing you’ll need to do is master the fundamentals of HTML, CSS and JavaScript. Then, you’ll be ready to start researching how to code using React.
...
Before jumping into a JavaScript library or framework, it is a good idea to learn the vanilla JavaScript. You can read through the article below
...
[From roadmap.sh](https://roadmap.sh/react)

[Back to top](#table-of-content)

## How to start coding using React
Here are a few tools you may want to set up in order to start working with React:

### Install NodeJS and NPM

[NodeJs](https://nodejs.org) and NPM are the runtime and command line tools required to build and run React applications.

### Install Git
The Git CLI is the command line interface used for cloning and interacting with git repositories (e.g. projects on GitHub). For more info see [git book](https://git-scm.com/book).
...
[create-react-app](https://create-react-app.dev) is a boilerplate that gives you everything you need to start a new React app. Many tutorials recommend that you start from the create-react-app project because all the basics are configured.
